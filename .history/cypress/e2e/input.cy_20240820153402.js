describe("Template Spec", () => {
    ...
    beforeEach("should set up the input fields and validate their state", () => {
    cy.xpath("//a[normalize-space()='Edit']").click();
        cy.get("#fullName").should("be.visible").type("Bene Quayson");    cy.get("#join").should("be.visible").type("Hey Bene, Welcome");
